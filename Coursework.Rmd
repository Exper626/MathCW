---
title: "Simulation and Modeling Techniques Coursework"
author: "Hanaa Azhar    20221313/2237922"
output:
...
Goal is to minimize customer waiting time
...
This question is about Power dissipated in a resistor.

equation: P = (V^2)/R

(12V ± 2V) and (8ohm ± 1ohm)
...
The sample size is "large" hence central limit theorem is used.
...
**Realization** is an instance of starting a **random walk**
